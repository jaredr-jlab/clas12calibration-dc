...
import static org.clas.detector.clas12calibration.dc.t2d.TableLoaderExtended.BfieldValues;
import static org.clas.detector.clas12calibration.dc.t2d.TableLoaderExtended.calc_Time;
import static org.clas.detector.clas12calibration.dc.t2d.TableLoaderExtended.maxTBin;

public class TimeToDistanceEstimatorExtended {

    public TimeToDistanceEstimatorExtended() {
    ...
    */
    public double interpolateOnGrid(double Bf, double alpha, double beta, double t,  int SecIdx, int SlyrIdx) {
        ...
        if(binhighBeta>TableLoaderExtended.betaValues.length-1)
            binhighBeta=TableLoaderExtended.betaValues.length-1;
        
        double beta1 = TableLoaderExtended.betaValues[binlowBeta];
        double beta2 = TableLoaderExtended.betaValues[binhighBeta];
        ...
        if(binhighB > TableLoaderExtended.maxBinIdxB) {
            binhighB = TableLoaderExtended.maxBinIdxB;
        }
        ...
        if(binhighAlpha > TableLoaderExtended.maxBinIdxAlpha) {
            binhighAlpha = TableLoaderExtended.maxBinIdxAlpha;
        }
        ...
        //return TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binlowAlpha][binlowBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binlowAlpha,binlowBeta)];
        // interpolate in B:
        double f_B_alpha1_beta1_t1 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binlowAlpha][binlowBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binlowAlpha,binlowBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binlowAlpha][binlowBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binhighB, binlowAlpha,binlowBeta)]);
        double f_B_alpha2_beta1_t1 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binhighAlpha][binlowBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binhighAlpha,binlowBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binhighAlpha][binlowBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binhighB, binhighAlpha,binlowBeta)]);
        double f_B_alpha1_beta1_t2 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binlowAlpha][binlowBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binlowB, binlowAlpha,binlowBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binlowAlpha][binlowBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binhighB, binlowAlpha,binlowBeta)]);
        double f_B_alpha2_beta1_t2 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binhighAlpha][binlowBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binlowB, binhighAlpha,binlowBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binhighAlpha][binlowBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binhighB, binhighAlpha,binlowBeta)]);
        double f_B_alpha1_beta2_t1 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binlowAlpha][binhighBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binlowAlpha,binhighBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binlowAlpha][binhighBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binhighB, binlowAlpha,binhighBeta)]);
        double f_B_alpha2_beta2_t1 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binhighAlpha][binhighBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binhighAlpha,binhighBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binhighAlpha][binhighBeta][this.getTimeIdx(t, SecIdx, SlyrIdx, binhighB, binhighAlpha,binhighBeta)]);
        double f_B_alpha1_beta2_t2 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binlowAlpha][binhighBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binlowB, binlowAlpha,binhighBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binlowAlpha][binhighBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binhighB, binlowAlpha,binhighBeta)]);
        double f_B_alpha2_beta2_t2 = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binhighAlpha][binhighBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binlowB, binhighAlpha,binhighBeta)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binhighAlpha][binhighBeta][this.getTimeNextIdx(t, SecIdx, SlyrIdx, binhighB, binhighAlpha,binhighBeta)]);
...
//        
        ...
        double deltatime_beta = util.getDeltaTimeBeta(x,beta,TableLoaderExtended.distbeta[SecIdx][SlyrIdx],TableLoaderExtended.v0[SecIdx][SlyrIdx]);
        ...
        if(calctime-t>2)   {                  
            ...
            for(int i = 1; i<101; i++) {
                ...
                deltatime_beta = util.getDeltaTimeBeta(x,beta,TableLoaderExtended.distbeta[SecIdx][SlyrIdx],TableLoaderExtended.v0[SecIdx][SlyrIdx]);
                calctime+=deltatime_beta;
                if(calctime<t) break;
    ...
    /*
        ...
        double f_B_alpha1_t = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binlowAlpha][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binlowAlpha)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binlowAlpha][this.getTimeIdx(t, SecIdx, SlyrIdx, binhighB, binlowAlpha)]);
        double f_B_alpha2_t = interpolateLinear(B*B, B1*B1, B2*B2, 
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binlowB][binhighAlpha][this.getTimeIdx(t, SecIdx, SlyrIdx, binlowB, binhighAlpha)],
                    TableLoaderExtended.DISTFROMTIME[SecIdx][SlyrIdx][binhighB][binhighAlpha][this.getTimeIdx(t, SecIdx, SlyrIdx, binhighB, binhighAlpha)]);
    ...
    */
    ...
    public int getTimeIdx(double t1, int is, int ir, int ibfield, int icosalpha, int ibeta) {
        ...
        if(binIdx<0) {
            binIdx = TableLoaderExtended.minBinIdxT;
        }
        if(binIdx>maxTBin) {
            binIdx = maxTBin ;
        }
...
//        if(binIdx<0) {
//            binIdx = TableLoaderExtended.minBinIdxB;
//        }
//        if(binIdx>TableLoaderExtended.maxBinIdxB) {
//            binIdx = TableLoaderExtended.maxBinIdxB;
//        }
        int maxBinIdxB = TableLoaderExtended.BfieldValues.length-1;
        DecimalFormat df = new DecimalFormat("#");
        df.setRoundingMode(RoundingMode.CEILING);
    ...
    private int getAlphaIdx(double alpha) {
        ...
        if(binIdx<0) {
            binIdx = TableLoaderExtended.minBinIdxAlpha;
        }
        if(binIdx>TableLoaderExtended.maxBinIdxAlpha) {
            binIdx = TableLoaderExtended.maxBinIdxAlpha;
        } 
        return binIdx;
    }
    
    private int getBetaIdx(double beta) {
        if(beta>=1.0) return TableLoaderExtended.betaValues.length-1;
        int value = TableLoaderExtended.betaValues.length-1;
        for(int i = 0; i<TableLoaderExtended.betaValues.length-1; i++) {
            if(beta>TableLoaderExtended.betaValues[i] && beta<=TableLoaderExtended.betaValues[i+1]) {
                value = i;
            }
        }
        return value;
    ...
    private int getTimeNextIdx(double t, int SecIdx, int SlyrIdx, int binlowB, int binlowAlpha, int binlowBeta) {
        ...
        if(binhighT>TableLoaderExtended.maxBinIdxT[SecIdx][SlyrIdx][binlowB][binlowAlpha]) {
            binhighT=TableLoaderExtended.maxBinIdxT[SecIdx][SlyrIdx][binlowB][binlowAlpha];
        }
        return binhighT;
    }
